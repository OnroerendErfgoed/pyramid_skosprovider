...
from skosprovider.skos import ConceptScheme, Concept, Collection, Label, Note, Source
...
def label_adapter(obj, request):
    ...
    :rtype: :class:`dict`
    """
    return {'label': obj.label, 'type': obj.type, 'language': obj.language}
...
def source_adapter(obj, request):
    ...
    :rtype: :class:`dict`
    """
    return {'citation': obj.citation, 'markup': obj.markup}
